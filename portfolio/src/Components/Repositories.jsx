...
const RepCards = (props) => {
    return(
        <>
            <div className="bg-gray-200 p-5 flex flex-col md:flex-row items-center gap-5 rounded-lg shadow-lg">
                <img src={props.imgsrc} alt="Error!" className="rounded-[50px] shadow-lg w-[100px] "/>
