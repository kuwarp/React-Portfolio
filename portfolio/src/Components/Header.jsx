...
const Header = () => {
    ...
    return(
        <>
         ...
         <section id="home">
         <div className="max-w-[1400px] mx-auto py-5 flex flex-col md:flex-row md:py-[20px]" >
            ...
            <div className="basis-[50%]">
                ...
                <div className="p-5 my-[10px] md:my-[110px]  md:leading-relaxed font-sans">
                    ...
                    font-medium  mx-auto my-5 py-3 text-white
                     bg-cyan-500 shadow-lg shadow-cyan-500/50 text-[18px] sm:w-[150px] tab:mx-[42%] md:mx-0'>Hire me</button></a>
                  ...
                  <div className="max-w-[300px] flex flex-row gap-8 mt-5 md:mt-10 tab:mx-[35%] md:ml-0">
                    ...
                    <a href = "https://github.com/Adityasingh39"><FaGithub size="25" className="text-cyan-500"/></a>
