    ...
    return(
        ...
        <div className="w-full p-5 bg-cyan-700 overflow-hidden" >
            ...
            <div className="max-w-[1200px] mx-auto p-2  flex flex-col md:flex-row sm:space-y-[20px] md:space-x-[100px]">
                ...
                <div className="flex flex-col justify-between md:py-14">
                    ...
                    <div className="inline-flex space-x-2 items-center">
                        <FaEnvelope/>
                        <span>aps08072001@gmail.com</span> 
                    </div>
                    ...
                    <a href = "https://github.com/Adityasingh39"><FaGithub/></a>
                ...
                <div className="relative z-10 bg-white rounded-xl shadow-lg sm:px-6 sm:py-8 tab:p-8 text-gray-600 md:w-250">
                    <form ref={form} onSubmit={sendEmail} className="flex flex-col space-y-4 text-gray-800">
                        ...
                        uppercase text-sm tab:text-lg md:text-sm"/>
