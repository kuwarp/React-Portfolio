...
const About = () => {
    return(
        ...
        {/* About Design */}
        <section id="about" className="sm:mb-[-50px] md:mb-[110px]">
        ...
        <div className="max-w-[1220px] mx-auto flex flex-col md:flex-row mt-[-30px] md:my-9  md:gap-x-[130px]  p-5" >
            ...
            <div className="basis-[20%] md:basis-[35%] bg-contain rounded-[50px] md:drop-shadow-2xl items-center mx-auto">
                <img src={about} alt="Error!" className="rounded-[50px] tab:w-[500px] md:w-[400px]"/>
            </div>

            <div className="basis-[50%] p-4 text-justify md:mt-[6%] tab:mt-3">
                 ...
                 if you feel that I'm eligible for your job post so please you can contact me at <span className="font-bold text-cyan-500">
                    aps08072001@gmail.com</span></p>

                <a download="Resume.pdf" href="Resume.pdf"><button className='w-[350px] rounded-md 
                    font-medium  mx-auto my-5 py-3 text-white
                     bg-cyan-500 shadow-lg shadow-cyan-500/50 text-[18px] 
                     sm:w-[150px] tab:mx-[42%] md:mx-0'>Download CV</button></a>
